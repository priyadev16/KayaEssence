  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-rose-50 via-pink-50 to-purple-50 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-1/2 left-10 w-40 h-40 bg-gradient-to-r from-purple-400/10 to-pink-400/10 rounded-full blur-xl animate-bounce" />
      </div>
      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen py-8 px-4 sm:px-6 lg:px-8">
        <div className="max-w-md w-full space-y-8">
          ...
          <div className="bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/50 hover:shadow-3xl transition-all duration-500 p-6 sm:p-8 lg:p-10 relative overflow-hidden">
            ...
            <div className="absolute top-0 right-0 w-48 h-48 bg-gradient-to-l from-white/10 to-transparent rounded-full -translate-x-1/2 -translate-y-1/2" />
            
            <form onSubmit={handleSubmit} className="space-y-6">
              {/* Full Name Field */}
              <div className="space-y-3">
                <label className="block text-sm font-bold text-gray-900 tracking-wide">Full Name</label>
              ...
              {/* Password Field */}
              <div className="space-y-3">
                <label className="block text-sm font-bold text-gray-900 tracking-wide">Create Password</label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                    <svg className="h-5 w-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="flex items-center space-x-4 pt-1">
                  <div className="flex items-center">
                    <input id="terms" name="terms" type="checkbox" className="h-4 w-4 text-pink-600 focus:ring-pink-500 border-gray-300 rounded" required />
                    <label htmlFor="terms" className="ml-2 block text-xs text-gray-700">
                      I agree to the{' '}
                      <Link href="/terms" className="text-pink-600 hover:text-pink-700 font-semibold transition-colors">Terms & Conditions</Link>
                    </label>
                  </div>
                </div>
              </div>
            ...
            <div className="relative my-8">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="px-4 bg-white/95 backdrop-blur-sm text-gray-500 font-medium">or sign up with</span>
              </div>
            </div>
            ...
            <div className="pt-6 text-center">
              <p className="text-sm text-gray-600">
                ...
                <Link href="/login" className="font-bold text-pink-600 hover:text-pink-700 transition-all duration-200 bg-gradient-to-r from-transparent to-transparent bg-[length:0%_2px] bg-bottom bg-no-repeat hover:bg-pink-600/20 hover:bg-[length:100%_2px] px-1 py-1 rounded">
                  Sign in instead
                </Link>
              </p>
            </div>
